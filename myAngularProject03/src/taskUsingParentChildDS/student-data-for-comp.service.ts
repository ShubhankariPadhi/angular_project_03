...
export class StudentDataForCompService {
  getStudentData(){
    return [
  ...
  /*getStudentData(){
    return [
      {"id":1, "name":"subha","area": 'srnagar',"zipcode":500016},
      {"id":2,"name":"latus","area": 'srnagar',"zipcode":500016},
      {"id":3, "name":"akhil","area": 'balkampet',"zipcode":500016},
      {"id":4,"name":"gufs","area": 'yusufguda',"zipcode":500019},
      {"id":5, "name":"bhranti","area": 'koti',"zipcode":500002},
      {"id":6,"name":"anil","area": 'srnagar',"zipcode":500016},
    ];
  }
  getStudentMarks(){
    return [
      {"id":1,"english": 79,"math":88,"physics":95,"chemistry":92,"IT":97},
      {"id":2,"english": 85,"math":77,"physics":87,"chemistry":87,"IT":95},
      {"id":3,"english": 83,"math":86,"physics":83,"chemistry":93,"IT":96},
      {"id":4,"english": 77,"math":84,"physics":87,"chemistry":92,"IT":94},
      {"id":5,"english": 76,"math":83,"physics":86,"chemistry":93,"IT":93},
      {"id":6,"english": 86,"math":77,"physics":87,"chemistry":93,"IT":95},
    ];
  }*/
  constructor() { }
